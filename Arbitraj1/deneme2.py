...
def initialize_arb():
    ...
    for arb_market in list_of_arb_sym:
        calc_profit_list.append(arbitrage_bin(arb_market, tickers))

def arbitrage_bin(list_of_sym, tickers):
    ...
    for sym in list_of_sym:
        if sym in list_of_sym:
            if i%2 == 0:
                ...
                print(sym+ "Kur: {}".format(depth['bids'][0][0]))
            elif i == 1:
        ...
        if a!= 3:
            ...
            print("AL: {}".format(exch_rate_list[0]))
            rate2 = price3/price2
        ...
        if float(rate1)<float(rate2):
            ...
            print("Arbitraj Mumkun Olabilir")
            print("Potansiyel kar : %"+str(arb_profit))
            print("Potansiyel fee : %"+str(arb_profit_fees))
            print("Net kar : %"+str(arb_profit_adjust))
